...
category: 'NVIDIA'
image: /img/field-notes/2026-06-22-fastest-path-ai-vision-nvidia-thumb.gif
image_source: local:deepstream-demo.gif
---
...
<PullQuote>
  Roughly **nine minutes** to download every package. **One minute, fifteen seconds** to build the
  image.
</PullQuote>
