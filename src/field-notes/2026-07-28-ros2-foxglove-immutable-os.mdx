...
This is a local deployment. To issue an OTA you will need an Avocado Connect account, and run `avocado connect auth login` and `avocado connect init`. This will configure your project with your new account. Then run `avocado install -f` and `avocado build` again. Upload your runtime with `avocado connect upload dev`. Then create a deployment and issue your OTA.
