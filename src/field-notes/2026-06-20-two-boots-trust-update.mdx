...
image: /img/field-notes/2026-06-20-two-boots-trust-update-thumb.png
image_source: local:two-boots-trust-update.jpg
...
<PullQuote>
  Rotate the signing key across the fleet without touching a device: the difference between a key
  compromise being a routine rotation and being a recall.
</PullQuote>
