...
tested_against: 'Avocado [ENGINEER: CLI version], avocado-imx93-frdm (AHAB Secure Boot + OP-TEE fTPM), avocado-qemuarm64 (fTPM via QEMU)'
poster: jtia
...
| :---- | :---- | :---- | :---- | :---- | :---- |
| `avocado-imx93-frdm` (hardware) | [ENGINEER: confirm on-hardware] | [ENGINEER: confirm on-hardware, OP-TEE fTPM PCR 7] | [ENGINEER: confirm] | [ENGINEER: confirm] | [ENGINEER: confirm] |
| `avocado-qemuarm64` (E2E CI) | `fvl_assert_luks_var` | `fvl_assert_luks_var_tpm` | `fvl_assert_dm_verity` | [ENGINEER: assert exists?] | [ENGINEER: assert exists?] |
...
<PullQuote>The storage chip alone is worthless: the key is sealed to the Secure Boot state, and the TPM is not on the chip.</PullQuote>
