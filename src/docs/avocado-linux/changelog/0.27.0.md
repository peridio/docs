...
See the [custom kernel guide](../guides/custom-kernel) for a complete walkthrough.
...
See the [packaging section of the cross-compilation guide](../guides/cross-compilation#packaging) for a complete example.
