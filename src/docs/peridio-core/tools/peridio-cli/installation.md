...
title: Installation
sidebar_position: 2
description: 'Install Peridio CLI for device and fleet management - download, extract, and verify installation with upgrade instructions for comprehensive platform access.'
---
