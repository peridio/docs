...
The submitted key may now be used to sign [binaries](/peridio-core/guides/binary-management/creating-binary-signatures) and [firmware](/peridio-core/guides/deprecated/creating-firmware#sign-the-fwup-archive).
