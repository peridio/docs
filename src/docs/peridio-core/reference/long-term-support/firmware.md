...
Find additional information in the Admin API [firmware section](/peridio-core/tools/admin-api#firmware) and the [creating firmware](/peridio-core/guides/deprecated/creating-firmware) guide.
