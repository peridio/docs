...
- Boot into recovery mode:
  - <span style={{ border: '1px solid black', background: 'yellow', width: '100px' }}>
      &nbsp;&nbsp;&nbsp;
    </span>
    yellow: short `FC REC` to `GND`
- Connect your serial console adapter to the target device:
  - <span style={{ border: '1px solid black', background: 'green', width: '100px' }}>
      &nbsp;&nbsp;&nbsp;
    </span>
    green: `GND` to adapter UART GND
  - <span style={{ border: '1px solid black', background: 'blue', width: '100px' }}>
      &nbsp;&nbsp;&nbsp;
    </span>
    blue: `UART TXD` to adapter UART RX
  - <span style={{ border: '1px solid black', background: 'violet', width: '100px' }}>
      &nbsp;&nbsp;&nbsp;
    </span>
