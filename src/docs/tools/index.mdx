      ...
      <Card className={styles.toolCard}>
        <CardBody className={styles.toolCardBody}>
          <div className={styles.toolCardContent}>
            ...
            <p>
              Manage Avocado Linux system extensions and hardware-in-the-loop testing. 
              Runtime control for systemd-sysext extensions with merge, unmerge, and refresh operations.
            </p>
          </div>
          <p className={styles.toolCardLinks}>
