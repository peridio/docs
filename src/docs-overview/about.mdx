...
- **Immutable rootFS** — erofs, read-only. A/B boot slots. BTRFS `/var` for extensions and data.
...
- [Features](/avocado-os/features) — Architecture decisions and tradeoffs
- [Core Concepts](/avocado-os/core-concepts) — avocado.yaml, runtimes, extensions, packages, systemd
