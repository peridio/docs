...
![The agent panel: a plain-English prompt, then the agent listing projects, cloning the references repo, and finding a Rust example on its own.](/img/field-notes/agentic-mcp-pi-exporter-chat.png)
...
![The agent's summary of the extension it created and built, following a reference structure.](/img/field-notes/agentic-mcp-pi-exporter-result.png)
...
![The booted board in Avocado Desktop's serial monitor, with its service running.](/img/field-notes/agentic-mcp-pi-exporter-boot.png)
