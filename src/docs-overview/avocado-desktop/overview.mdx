...
<div style={{ marginBottom: '1.75rem' }}>
  <CalloutButton
    ...
    cta="Download →"
    href="/developer-reference/getting-started/download"
  />
</div>
...
1. **Install the app** — download the [macOS release](/developer-reference/getting-started/download) directly, or install it with Homebrew: `brew install --cask avocado-linux/tap/avocado-desktop`. Avocado Desktop requires macOS 13.0 (Ventura) or later.
