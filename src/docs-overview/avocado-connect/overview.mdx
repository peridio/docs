---
title: 'Overview'
description: 'Avocado Connect is the fleet management and device operations platform for Avocado OS: OTA updates, remote access, device monitoring, and compliance tracking for deployed fleets.'
---
