...
{/* Keep on one line — Prettier line breaks create visible whitespace in MDX */}
...
<a href="https://www.peridio.com/join-our-discord" target="_blank" rel="noopener noreferrer" style={{display: 'inline-flex', alignItems: 'center', background: 'var(--ifm-color-primary)', color: '#fff', padding: '0.45rem 1rem', borderRadius: '6px', textDecoration: 'none', fontSize: '0.8rem', fontWeight: 600, boxShadow: '0 0 16px rgba(123, 111, 240, 0.25)'}}>Join our Discord →</a>
</div>
