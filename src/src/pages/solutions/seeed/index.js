...
const solutionData = {
  ...
  workInProgress: {
    ...
    message: 'We\'re actively working on a comprehensive provisioning guide for the Seeed reTerminal. This will include step-by-step instructions for device setup, configuration, and deployment.',
    type: 'provisioning',
  },
}
