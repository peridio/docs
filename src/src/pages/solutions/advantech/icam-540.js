...
const solutionData = {
  ...
  hero: {
    ...
    subtitle: "Transform your Advantech ICAM-540 from AI development platform to production-grade industrial vision system with enterprise Linux and fleet management",
    stats: [
  ...
  features: [
    {
      ...
      description: "Pre-hardened Linux OS with CAMNavi SDK, DeepStream, and TensorRT pre-integrated. No prototype-to-production gap."
    },
    {
      icon: "CpuChip",
      title: "Atomic AI Model Updates",
      description: "Zero-downtime model deployment with automatic rollback on performance degradation. Version control and A/B testing for continuous improvement."
    },
    {
      icon: "ShieldCheck",
      title: "Enterprise Security",
      description: "Hardware-accelerated encryption, secure boot, and certificate-based authentication. Zero-trust architecture built for industrial vision systems."
    },
    {
      icon: "GlobeAlt",
      title: "Vision Fleet Management",
      description: "Deploy and manage hundreds of ICAM-540 cameras across industrial sites. Site-specific configurations with centralized policy enforcement."
    },
    {
      icon: "BuildingOffice",
    ...
    },
    {
      ...
      description: "Hardware acceleration for GStreamer pipelines and TensorRT inference. Automatic resource allocation for multi-model concurrent processing."
    }
  ],
