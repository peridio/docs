...
const solutionData = {
  ...
  hero: {
    ...
    subtitle: "Production-ready Qualcomm RB3 Gen 2 deployment in 3-6 months with Peridio Fleet + Avocado OS",
    stats: [
  ...
  features: [
    {
      ...
      description: "Native support for Qualcomm AI Engine and Hexagon SDK. Streamlined deployment of TensorFlow Lite, ONNX, and PyTorch models."
    },
    {
      icon: "RocketLaunch",
      title: "Rapid Deployment",
      description: "Optimized BSPs for Qualcomm silicon enable fast boot and deterministic builds. Pre-integrated drivers reduce development time."
    },
    {
      icon: "LockClosed",
      title: "Hardware Security",
      description: "Hardware-backed security with TrustZone, secure boot, and verified boot. LUKS encryption and dm-verity ensure data integrity."
    },
    {
      icon: "Wifi",
      title: "Fleet Operations",
      description: "Comprehensive device management through Peridio Fleet with remote diagnostics, phased updates, and fleet-wide security patching."
    },
    {
      icon: "GlobeAlt",
      title: "Cross-Platform",
      description: "Unified development experience across ARM SoCs (NVIDIA Jetson, NXP i.MX, Qualcomm QCS) with portable application layers."
    },
    {
      icon: "ShieldCheck",
      title: "Long-term Support",
      description: "10+ years of maintenance ensures device longevity and reduces lifecycle management overhead for enterprise deployments."
    }
  ],
