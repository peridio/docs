...
const solutionData = {
  ...
  hero: {
    ...
    subtitle: "Transform your OnLogic FR201 from development platform to production gateway with enterprise-grade Linux deployment",
    stats: [
  ...
  features: [
    {
      ...
      description: "Pre-hardened Linux OS with read-only root filesystem, secure boot, and atomic updates. No prototype-to-production gap."
    },
    {
      icon: "Bolt",
      title: "Atomic Update Architecture",
      description: "Zero-downtime updates with automatic rollback on failure. System integrity guaranteed with cryptographic verification and watchdog protection."
    },
    {
      icon: "GlobeAlt",
      title: "Industrial-Grade Fleet Management",
      description: "Deploy and manage thousands of gateways across industrial sites. Site-specific configurations with centralized policy enforcement."
    },
    {
      icon: "WrenchScrewdriver",
      title: "Cross-Platform Portability",
      description: "Develop on FR201, deploy across industrial hardware. Unified toolchain prevents vendor lock-in and reduces engineering overhead."
    },
    {
      icon: "ShieldCheck",
      title: "Enterprise Security",
      description: "TPM 2.0 integration, full-disk encryption, and certificate-based authentication. Zero-trust architecture built for industrial environments."
    },
    {
      icon: "Fire",
      title: "Hardware-Optimized Performance",
      description: "Thermal management optimizations for fanless operation. Automatic resource allocation and workload distribution for 24/7 uptime."
    }
  ],
