  ...
  return (
    <Layout>
      <Head>
        ...
        <meta property="og:title" content="NVIDIA Jetson Orin Nano Production Linux | Day 1 Ready | Peridio" />
        <meta property="og:description" content="Production-ready NVIDIA Jetson Orin Nano deployment from day 1 with Peridio Fleet + Avocado OS. Enterprise Linux and secure fleet management." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Day 1 production-ready Linux and device management for NVIDIA Jetson Orin Nano with enterprise-grade embedded OS",
            "manufacturer": {
              "@type": "Organization",
              "name": "Peridio"
            },
