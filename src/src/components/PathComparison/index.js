    ...
    <div className={styles.comparisonWrapper}>
      <div className={styles.pathRow}>
        <div className={styles.pathBlock}>
          <div className={styles.pathBlockHeader}>
            <h4>The Ubuntu / Debian Path <span className={styles.subtitle}>Ship fast</span></h4>
          </div>
        ...
        <div className={styles.pathBlock}>
          <div className={styles.pathBlockHeader}>
            <h4>The Yocto / Buildroot Path <span className={styles.subtitle}>Ship safe</span></h4>
          </div>
          <div className={styles.pathBlockBody}>
            <div className={styles.section}>
              <div className={styles.sectionLabel}>What you get</div>
      ...
      <div className={styles.resolutionBlock}>
        <div className={styles.resolutionHeader}>
          <h4>Avocado OS <span className={styles.subtitle}>Yocto's production guarantees. Ubuntu's developer experience.</span></h4>
        </div>
