  ...
  const menuSections = [
    {
      title: 'Documentation',
      items: [
        { label: 'Introduction', to: '/dev-center', category: 'Getting Started' },
        { label: 'Provision Device', to: '/dev-center/getting-started/provision-device', category: 'Getting Started' },
        { label: 'Hardware in the Loop', to: '/dev-center/getting-started/hardware-in-the-loop', category: 'Getting Started' },
        { label: 'Desktop Deploy', to: '/dev-center/getting-started/desktop-deploy', category: 'Getting Started' },
        { label: 'Avocado OS', to: '/dev-center/avocado-linux/introduction', category: 'Core Platforms' },
        { label: 'Peridio Core', to: '/dev-center/peridio-core/introduction', category: 'Core Platforms' },
        { label: 'Supported Hardware', to: '/dev-center/hardware/supported-hardware', category: 'Core Platforms' },
        { label: 'Integration Guides', to: '/dev-center/integration', category: 'Core Platforms' },
        { label: 'Tools', to: '/dev-center/tools', category: 'Resources' },
        { label: 'Tunnels (Remote Access)', to: '/dev-center/tunnels/overview', category: 'Resources' },
        { label: 'Webhooks', to: '/dev-center/integration/webhooks/overview', category: 'Resources' },
        { label: 'Certificates', to: '/dev-center/integration/certificates/overview', category: 'Resources' },
      ],
    },
    {
      ...
      items: [
        ...
        { label: 'Advantech ICAM 540', to: '/solutions/advantech/icam-540', category: 'Production Ready' },
        ...
        ...(isDevelopment ? [
          ...
          { label: 'Qualcomm Rubik Pi', to: '/solutions/qualcomm/rubik-pi', category: 'Pre-review' },
          { label: 'STMicro STM32MP257F', to: '/solutions/stmicro/stm32mp157d-dk', category: 'Pre-review' },
        ] : []),
      ],
    },
    {
          ...
          {menuSections.map((section, index) => {
            ...
            return (
              <div key={index} className="mobile-menu-section">
                ...
                >
                  <span className="mobile-menu-section-header">
                    {section.title}
                  </span>
                  <svg
                    width="16"
