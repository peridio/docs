...
function GitHubIcon() {
  return (
    <svg className={styles.ghIcon} viewBox="0 0 16 16" width="16" height="16" aria-hidden="true">
      <path
        fill="currentColor"
      ...
      <dl className={styles.rows}>
        {targets.length > 0 && (
          <div className={styles.row}>
            <dt className={styles.key}>Targets tested</dt>
        ...
        {cli && (
          <div className={styles.row}>
            <dt className={styles.key}>Avocado CLI</dt>
            <dd className={styles.val}>
              <code>{cli}</code>
            </dd>
          </div>
        ...
        {reference && (
          <div className={styles.row}>
            <dt className={styles.key}>Reference</dt>
            <dd className={styles.val}>
