            ...
            items: [
              {
                type: 'html',
                value:
                  '<div class="dropdown__menu--grid-container"><div class="dropdown__menu--column"><div class="dropdown__menu--section-title">GETTING STARTED</div><a href="/avocado-linux/guides/getting-started/overview" class="dropdown__menu--link">Getting started</a><a href="/hardware/qemu/x86-64/provision/" class="dropdown__menu--link">Provision a Device</a><a href="/avocado-linux/guides/getting-started/hardware-in-the-loop" class="dropdown__menu--link">Hardware in the Loop</a><a href="/avocado-linux/guides/getting-started/sideload-an-update" class="dropdown__menu--link">Sideload an Update</a></div><div class="dropdown__menu--column"><div class="dropdown__menu--section-title">CORE PLATFORMS</div><a href="/avocado-linux/overview" class="dropdown__menu--link">Avocado OS</a><a href="/peridio-core/introduction" class="dropdown__menu--link">Peridio Core</a><a href="/integration" class="dropdown__menu--link">Integration Guides</a></div><div class="dropdown__menu--column"><div class="dropdown__menu--section-title">RESOURCES</div><a href="/peridio-core/tunnels/overview" class="dropdown__menu--link">Remote Access Tunnels</a><a href="/integration/webhooks/overview" class="dropdown__menu--link">Webhooks</a><a href="/integration/certificates/overview" class="dropdown__menu--link">Certificates</a></div></div>',
              },
            ],
          },
          {
