            ...
            items: [
              {
                type: 'html',
                value:
                  '<div class="dropdown__menu--grid-container dropdown__menu--hardware"><div class="dropdown__menu--column"><div class="dropdown__menu--section-title">SEMICONDUCTORS</div><a href="/solutions/nxp/imx8mp" class="dropdown__menu--link">NXP i.MX 8M Plus</a><a href="/solutions/raspberry-pi/raspberry-pi-5" class="dropdown__menu--link">Raspberry Pi 5</a><a href="/solutions/nvidia/jetson-orin-nano" class="dropdown__menu--link">NVIDIA Jetson</a></div><div class="dropdown__menu--column"><div class="dropdown__menu--section-title">PRODUCTION READY</div><a href="/solutions/advantech/icam-540" class="dropdown__menu--link">Advantech ICAM-540</a><a href="/solutions/onlogic/fr201" class="dropdown__menu--link">OnLogic FR201</a><a href="/solutions/seeed/reterminal" class="dropdown__menu--link">Seeed reTerminal</a></div></div><div style="margin-top: 1.75rem; text-align: right;"><a href="/hardware/support-matrix" style="font-size: 0.85rem; color: #666; opacity: 0.9; text-decoration: none; transition: opacity 0.2s ease;" onmouseover="this.style.opacity=\'1\'; this.style.color=\'#333\';" onmouseout="this.style.opacity=\'0.9\'; this.style.color=\'#666\';">View all supported hardware →</a></div>',
              },
            ],
          },
          {
