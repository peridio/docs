...
<HardwareHero
  vendor="Intel"
  model="Intel x86-64-v2"
  tagline="Generic x86-64 microarchitecture level 2 target for broad Intel and AMD hardware compatibility."
  stats={[
    { value: 'x86-64-v2', label: 'Instruction Set' },
    { value: 'Broad', label: 'Hardware Compatibility' },
    { value: 'Industrial & Edge', label: 'Deployment Target' },
    { value: 'Nehalem+', label: 'Intel Support' },
    { value: 'Bulldozer+', label: 'AMD Support' },
