...
<HardwareHero
  vendor="Seeed Studio"
  vendorUrl="https://www.seeedstudio.com/ReTerminal-with-CM4-p-4904.html"
  model="Seeed reTerminal"
  tagline="Production-Ready Yocto Linux for reTerminal in Days, Not Months. Build industrial HMI applications with the security and scalability of Yocto, plus the rapid development cycles your team needs."
  image="/img/hardware/seeed/seeed_reterminal.png"
  imageAlt="Seeed reTerminal industrial HMI"
  stats={[
    { value: '5"', label: 'IPS Touchscreen' },
    { value: '1.5 GHz', label: 'Quad-Core ARM (CM4)' },
    { value: 'IP64', label: 'Front Panel Rating' },
    { value: '<30s', label: 'Cold Boot to UI' },
    { value: '1000+', label: 'Fleet Scalability' },
    { value: '7 Years', label: 'Avocado OS LTS' },
  ]}
  target="reterminal"
  ctas={{
    primary: {
