...
<HardwareHero
  vendor="Seeed Studio"
  vendorUrl="https://www.seeedstudio.com/ReTerminal-DM-p-5616.html"
  model="Seeed reTerminal DM"
  tagline="Industrial-grade 10.1-inch HMI with Raspberry Pi CM4, RS485, CAN bus, DI/DO, PoE, and optional 4G/LoRa for factory automation and edge computing."
  stats={[
    { value: '10.1"', label: 'IPS Touchscreen' },
    { value: '1.5 GHz', label: 'Quad-Core ARM (CM4)' },
    { value: 'RS485/CAN/DI/DO', label: 'Industrial I/O' },
    { value: 'IP65', label: 'Front Panel Rating' },
    { value: '8GB / 32GB eMMC', label: 'On-Board Memory & Storage' },
    { value: 'PoE + 4G/LoRa', label: 'Flexible Connectivity' },
  ]}
