...
<HardwareHero
  vendor="NXP"
  vendorUrl="https://www.nxp.com/products/processors-and-microcontrollers/arm-processors/i-mx-applications-processors/i-mx-9-processors/i-mx-93-applications-processor-family-arm-cortex-a55-ml-acceleration-power-efficient-mpu:i.MX93"
  model="NXP i.MX 93 EVK"
  tagline="Dual Cortex-A55 + Cortex-M33 heterogeneous platform with Ethos U-65 NPU, EdgeLock secure enclave, and modular connectivity for edge AI applications."
  image="/img/hardware/nxp/imx-93-evk.png"
  imageAlt="NXP i.MX 93 EVK"
  stats={[
    { value: '1.7 GHz', label: 'Dual Cortex-A55' },
    { value: '0.5 TOPS', label: 'Ethos U-65 NPU' },
    { value: '2GB', label: 'LPDDR4X Memory' },
    { value: 'Cortex-M33', label: '200 MHz Real-Time Core' },
    { value: 'Wi-Fi 6 + BT 5.2', label: 'Tri-Radio Connectivity' },
