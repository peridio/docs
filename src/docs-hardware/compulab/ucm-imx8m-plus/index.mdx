...
- Building on this SOM for CompuLab's **IOT-GATE-iMX8PLUS** gateway carrier (cellular, GPS, CAN, optional M.2 TPM)? See the [IOT-GATE-iMX8PLUS page](/hardware/compulab/iot-gate-imx8plus) for the carrier extension that brings those peripherals up.
