...
<HardwareHero
  vendor="Advantech"
  vendorUrl="https://www.advantech.com/en-us/products"
  model="ICAM-540"
  ...
  ctas={{
    ...
    secondary: {
      ...
      to: 'https://blog.peridio.com/hubfs/Hardware%20Solution%20Briefs/Advantech-ICAM-540.pdf',
      external: true,
    },
  }}
/>
...
Follow the [Any Supported Target](/developer-reference/getting-started/any-target) instructions under Getting Started to begin. The ICAM-540 uses the `jetson-orin-nx` target with the `icam-540` board:
