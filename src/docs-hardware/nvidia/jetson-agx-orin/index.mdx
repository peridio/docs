...
<HardwareHero
  ...
  ctas={{
    primary: {
      label: 'Get Started',
      to: '/developer-reference/getting-started/any-target#jetson-agx-orin',
    },
  }}
/>
...
Follow the [Any Supported Target](/developer-reference/getting-started/any-target#jetson-agx-orin) instructions under Getting Started to begin. This target is `jetson-agx-orin`. The provisioning specifics are below.
...
Ready to build? Head to the [Jetson AGX Orin DevKit getting started guide](/developer-reference/getting-started/any-target#jetson-agx-orin).
