...
<HardwareHero
  ...
  tagline="Transform your Raspberry Pi 4 Model B prototype into a secure, manageable fleet with Peridio + Avocado OS."
  ...
  stats={[
    ...
    { value: '1.8 GHz', label: 'Quad-core Cortex-A72' },
    { value: 'Up to 8GB', label: 'LPDDR4 Memory' },
    { value: 'Dual 4K HDMI', label: 'Display Output' },
  ]}
  target="raspberrypi4"
  ctas={{
    primary: {
    ...
    secondary: {
      ...
      to: 'https://blog.peridio.com/hubfs/Hardware%20Solution%20Briefs/Raspberry%20Pi%204.pdf',
      external: true,
    },
  }}
/>
